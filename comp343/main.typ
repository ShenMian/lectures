...
#figure(caption: [分数构成])[
  #table(
    ...
    [CA1], [25%], [作业 (Technical Report)], [2026 年 3 月 20 日 (周五) 17:00],
    [CA2], [15%], [作业 (Research Essay)], [2026 年 5 月 7 日 (周四) 17:00],
    [Final Exam], [60%], [MCQ], [],
  )
]

== 报告 (Reporting Results)
...
+ Body of report
  ...
  + This is why I am qualified to do it.
  + This is what I did.
  + This is what I found.
  + These are my opinions/conclusions.
+ Conclusion
+ References
+ Glossary
+ Acknowledgements
...
不明确要求安装 CSI Linux 或 Kali Linux 的原因, 可能是因为包含取证工具, 以及在 macOS 下无法使用 Autopsy.
